    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-4">
        ...
        <h2 class="text-center text-lg font-semibold text-foreground">Iniciar sesion</h2>
            ...
            <div>
                ...
                <x-text-input id="email" class="mt-1 block h-10 w-full" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" maxlength="191" title="Introduce un correo electronico valido." placeholder="admin@negocio.local" />
